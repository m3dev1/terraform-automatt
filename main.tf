...
# S3 - Bucket ACLs
resource "aws_s3_bucket_ownership_controls" "automatt-tf" {
...
resource "aws_s3_bucket_acl" "automatt-tf" {
  depends_on = [
    aws_s3_bucket_ownership_controls.automatt-tf,
    aws_s3_bucket_public_access_block.automatt-tf,
   ]
